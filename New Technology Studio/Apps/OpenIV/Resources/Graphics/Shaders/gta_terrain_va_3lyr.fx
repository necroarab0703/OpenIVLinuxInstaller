...
struct VS_OUTPUT
{
    ...
    float4 DiffuseColor : COLOR0;    // vertex diffuse color (note that COLOR0 is clamped from 0..1)
    float4 Mask			: COLOR1;	
};
...
VS_OUTPUT VSBasic( VS_INPUT In )
{
	...
	// Layers mask
	Output.Mask.xy = In.vTexCoord3;
	Output.Mask.zw = In.vTexCoord4;
